...
const CHECK_COMMAND = [
  ...
  'if [ -n "$v" ]; then',
  '  echo "[JINHAK 표준 v${v} 감지] 업데이트 확인이 필요하면 /session-start 를 실행하세요.";',
  'elif [ -f CLAUDE.md ]; then',
  '  echo "[JINHAK 표준 미적용] CLAUDE.md는 있으나 표준 메타정보가 없습니다. /apply-standard 로 적용할 수 있습니다.";',
  'else',
  '  echo "[JINHAK 표준 미적용] /apply-standard 로 JINHAK AI 개발 표준을 적용할 수 있습니다.";',
  'fi',
].join(' ');
